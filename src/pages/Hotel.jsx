...
//   const [selectedRating, setSelectedRating] = useState(null);
//   const [selectedAmenities, setSelectedAmenities] = useState("Any Amenity");
//   const [selectedOptions, setSelectedOptions] = useState([]); // ✅ NEW
//   const [showAll, setShowAll] = useState(false);
//   const [filteredHotels, setFilteredHotels] = useState(null);
...
//       tags: ["Couple Friendly","Group Travellers"],
...
//       tags: ["Local ID Accepted"],
//       image: "/Budget_Stay.jpg",
//     },
//     {
//       id: 3,
//       name: "Cozy Inn",
...
//       tags: ["Family Friendly","Group Travellers"],
...
//         priceMatch = hotel.price < 5000;
//       else if (selectedPrice === "₹5,000 - ₹10,000")
//         priceMatch = hotel.price >= 5000 && hotel.price <= 10000;
//       else if (selectedPrice === "₹10,000 - ₹20,000")
//         priceMatch = hotel.price > 10000 && hotel.price <= 20000;
//       else if (selectedPrice === "Above ₹20,000")
//         priceMatch = hotel.price > 20000;

//       let ratingMatch = selectedRating
//         ? hotel.rating === selectedRating
//         : true;

//       let amenityMatch =
//         selectedAmenities === "Any Amenity"
//           ? true
//           : hotel.amenities.includes(selectedAmenities);

//       let optionMatch =
//         selectedOptions.length === 0 ||
//         selectedOptions.every((opt) => hotel.tags?.includes(opt));

//       return priceMatch && ratingMatch && amenityMatch && optionMatch;
//     });
...
//         {/* LEFT FILTER (OYO STYLE) */}
//         <div className="bg-white p-4 rounded-lg shadow h-fit">
//           <h2 className="font-semibold mb-3">Property Rules</h2>
...
//                   src={hotel.image}
//                   alt={hotel.name}
//                   className="h-40 w-full md:w-1/3 object-cover"
//                 />
