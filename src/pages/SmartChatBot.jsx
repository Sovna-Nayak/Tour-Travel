...
{!isOpen && (
  <button
    ...
    className="fixed bottom-20 right-4 z-50 w-16 h-16 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 shadow-[0_0_20px_rgba(236,72,153,0.7)] flex items-center justify-center hover:scale-110 transition"
  >
    <img
