...
const PropertyType = () => {
  ...
  const vehicles = [
    { name: "Mini Buses", icon: "🚌", desc: "Add buses for travel and tours." },
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fadeIn">
                    ...
                    {v.name === "Mini Buses" && (
                      <div
                        ...
                        className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg cursor-pointer flex items-center gap-3"
                      >
                        <span className="bg-blue-100 text-blue-600 p-2 rounded-full text-lg">🚌</span>
                        <div>
                          <p className="font-semibold">Register Bus</p>
                          <p className="text-xs text-gray-500">Add your bus service</p>
                        </div>
                      </div>
                    )}
                    ...
                    {v.name === "Cabs" && (
                      <>
                        <div 
                          onClick={() => navigate("/cab-registration/4")}
                          className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition cursor-pointer flex items-center gap-3"
                        >
                          <span className="bg-blue-100 text-blue-600 p-2 rounded-full text-lg">🚗</span>
                          <div>
                        ...
                        <div 
                          onClick={() => navigate("/cab-registration/6")}
                          className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition cursor-pointer flex items-center gap-3"
                        >
                          <span className="bg-blue-100 text-blue-600 p-2 rounded-full text-lg">🚐</span>
                          <div>
                        ...
                        <div 
                          onClick={() => navigate("/cab-registration/8")}
                          className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition cursor-pointer flex items-center gap-3"
                        >
                          <span className="bg-blue-100 text-blue-600 p-2 rounded-full text-lg">🚙</span>
                          <div>
...
{v.name === "Bikes" && (
  <>
    <div 
      onClick={() => navigate("/bike-registration/scooty")}
      className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition cursor-pointer flex items-center gap-3"
    >
    ...
    <div 
      onClick={() => navigate("/bike-registration/bullet")}
      className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition cursor-pointer flex items-center gap-3"
    >
      <span className="bg-purple-100 text-purple-600 p-2 rounded-full text-lg">🏍</span>
      <div>
    ...
    <div 
      onClick={() => navigate("/bike-registration/bike")}
      className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition cursor-pointer flex items-center gap-3"
    >
      <span className="bg-purple-100 text-purple-600 p-2 rounded-full text-lg">🚴</span>
      <div>
